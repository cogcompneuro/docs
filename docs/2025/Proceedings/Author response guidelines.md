...
| Period | Dates |
| :--- | :--- |
| Reviews Released | {{ proceedings_reviews_released_2025 }} |
| Author Responses Due | {{ proceedings_author_response_due_2025 }}, 11:59 PM Anywhere on Earth (AoE) |
| [Author-Reviewer Discussion](#discussion) | {{ proceedings_discussion_period_2025 }} |
...
a poster; Proceedings submissions that are not accepted will go through another decision
...
**Interest** (*To what extent is this work relevant to CCN?*)
...
- **Needs improvement** (lacks critical evidence; has methodological flaws that
  undermine conclusions)

**Clarity** (*Are the evidence and contributions clearly communicated?
...
**{{ proceedings_author_response_due_2025 }}**.
...
![OpenReview screenshot](../assets/author-response-1.png)
...
![OpenReview screenshot](../assets/author-response-2.png)
