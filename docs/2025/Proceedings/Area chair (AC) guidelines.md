...
You should become familiar with the contents of all your submissions and are responsible
...
| :--- | :--- | :--- |
| [Assignment](#assignment) | ACs matched with submissions. | {{ proceedings_review_period_2025 }} |
| [Review Period](#reviews) | Ensure all papers have 3+ reviews. | {{ proceedings_review_period_2025 }} |
| Reviews Due |  | {{ proceedings_reviews_due_2025 }}, 11:59 PM (AoE) |
| Author Response | Authors write responses. | {{ proceedings_author_response_period_2025 }} |
| Author Responses Due |  | {{ proceedings_author_response_due_2025 }}, 11:59 PM (AoE) |
| [Discussion](#discussion) | Authors interact with reviewers. | {{ proceedings_discussion_period_2025 }} |
| [Meta-Reviews](#meta-reviews) | ACs write meta-reviews. | {{ proceedings_meta_review_period_2025 }} |
| **Meta Review Due** | (**main AC deadline**) | **{{ proceedings_meta_review_due_2025 }}** |
| Final Decisions | SACs and TPC finalize decisions. | {{ proceedings_final_decisions_period_2025 }} |
...
Reviews are due **{{ proceedings_reviews_due_2025 }}**. Read all reviews carefully.
...
Please address and interpret any disagreements within the reviewers in your meta reviews
...
a recommendation that goes against the reviewer recommendations.
...
recommendation and reasoning behind it to the authors.
...
3. Your **meta-review**, where you describe if the reviewers’ points were sufficiently
   addressed by the authors and whether you as the AC found the reviewers’ points worthy
   of consideration in decision-making.
...
However, we encourage you to be **more specific** about the details of the claims and
evidence presented in the submission, as the below are deliberately vague (*i.e.,*
referring to “points”, “ideas”, “evidence”, rather than, for example, “… the absence of
statistical tests for the main effect of stimulus complexity on reaction time, that
weakens the central claim of the submission”). The latter is much preferred, both to
...
**Summary:**\
Both Reviewer 1 and 2 acknowledged the novelty and potential broader impact of the
paper.
...
was at least adequate and two reviews judged both of these as strong upon submission.
...
The authors replied by explaining why the suggested analysis on condition was not
